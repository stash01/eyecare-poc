...
const navItems = [
  ...
  { href: "/patient/dashboard/symptom-tracker",   icon: Activity,      label: "Symptom Tracker" },
  { href: "/patient/dashboard/records",           icon: FileText,      label: "Medical Records" },
  { href: "/patient/dashboard/prescriptions",     icon: Pill,          label: "Prescriptions" },
  { href: "/patient/dashboard/profile",           icon: User,          label: "Profile" },
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <main className="lg:col-span-3 space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Link href="/patient/dashboard/symptom-tracker">
                <div className="group relative p-5 rounded-2xl border border-stone-200 bg-white shadow-card hover:shadow-card-lg hover:-translate-y-0.5 transition-all h-full cursor-pointer">
